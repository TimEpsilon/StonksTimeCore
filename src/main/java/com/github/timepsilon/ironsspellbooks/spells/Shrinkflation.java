...
public class Shrinkflation extends AbstractPotionSpell {
    ...
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(Core.MODID, "shrinkflation");

    public Shrinkflation() {
        super(ModMobEffects.SHRINKFLATION, 30);
        this.castTime = 20*3;
